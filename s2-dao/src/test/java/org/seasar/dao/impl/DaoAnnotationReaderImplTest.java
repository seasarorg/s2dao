...
public class DaoAnnotationReaderImplTest extends S2TestCase {
	...
	public void testGetBean(){
		...
		BeanDesc beanDesc2 = BeanDescFactory.getBeanDesc(getDaoClass("DummyDao"));
		DaoAnnotationReader reader2 = readerFactory.createDaoAnnotationReader(beanDesc2);
		try{
	...
	public void testGetArgNames() throws Exception {
		...
		//getArgNames return 0 length array if args annotation is not specified.
